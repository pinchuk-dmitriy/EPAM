...
namespace AircompanyTests.Tests {
    ...
    public class AirportTest
    {
        ...
        public void GetTransportMilitaryPlanesTest()
        {
            ...
            Assert.assertTrue(transportMilitaryPlanes.Count > 0);
        }
        ...
        public void GetSortedByMaxLoadCapacityTest()
        {
            ...
            for (int i = 0; i < planesSortedByMaxLoadCapacity.Count - 1; i++) {
                Assert.assertTrue(planesSortedByMaxLoadCapacity[i + 1].GetMaxLoadCapacity() >
                        planesSortedByMaxLoadCapacity[i].GetMaxLoadCapacity());
            }
        }
    }
}
